...
var array5words = ['red', 'blue', 'green', 'grey', 'black']
...
for (i = 0; i < array5words.length; i++) {
    alert(array5words[i].substring(0,1).toUpperCase() + array5words[i].substring(1))
}
